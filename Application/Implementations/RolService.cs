...
namespace Application.Implementations
{
    public class RolService : IRolService
    {
        ...
        {
            List<Rol> rols = await _rolRepository.GetAll();
            List<RolDto> rolDtos = _mapper.Map<List<RolDto>>(rols);
            return rolDtos;
        }
        ...
        public async Task<int> Create(RolParametroDto rolParametroDto)
        {
            Rol rol = new Rol
            {
        ...
        public async Task Update(RolParametroDto rolParametroDto)
        {
            ...
            if (rol == null)
            {
                throw new Exception($"No existe rol con este ID:{rolParametroDto.Id}");
            }
